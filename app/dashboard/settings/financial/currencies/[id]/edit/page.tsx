...
export async function generateMetadata({ params }: EditCurrencyProps): Promise<Metadata> {
  ...
  return {
    ...
    description: "Adjust baseline localization accounting layouts rules settings or alter manual adjustment valuation override coefficient factors fields links trackers."
  };
}
